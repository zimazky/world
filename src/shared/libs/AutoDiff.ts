...
import { Vec2, Vec3 } from 'src/shared/libs/Vectors/Vectors'
...
/**
 * Класс чисел с возможностью автоматического дифференцирования по x и y
 * Числа представляются составными:
 * value - значение функции
 * diff - частные производные по трем координатам x, y, z
 */
...
/**
 * Класс чисел с возможностью автоматического дифференцирования по x, y и z
 * Числа представляются составными:
 * value - значение функции
 * diff - частные производные по трем координатам x, y, z
 */

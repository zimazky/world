// import { Vec3 } from 'src/shared/libs/Vectors/Vectors'
...
//   /** Положение вершины */
//   p: Vec3
//   /** Индексы примыкающих ребер */
//   e: number[]
//   /** Индексы примыкающих граней */
//   f: number[]
// }

// type Edge = {
//   /** Индексы вершин на концах ребра */
//   n: [number, number]
//   /** Индексы прилегающих граней */
//   f: number[]
// }
...
//   static generateIcosahedron(): Icosahedron {
//     const phi = (1.0 + Math.sqrt(5.0)) / 2.0
//     const du = 1.0 / Math.sqrt(phi * phi + 1.0)
//     const dv = phi * du;
    
//     const nodes: Node[] = [
//       { p: new Vec3(0, +dv, +du), e: [], f: [] },
//       { p: new Vec3(0, +dv, -du), e: [], f: [] },
//       { p: new Vec3(0, -dv, +du), e: [], f: [] },
//       { p: new Vec3(0, -dv, -du), e: [], f: [] },
//       { p: new Vec3(+du, 0, +dv), e: [], f: [] },
//       { p: new Vec3(-du, 0, +dv), e: [], f: [] },
//       { p: new Vec3(+du, 0, -dv), e: [], f: [] },
//       { p: new Vec3(-du, 0, -dv), e: [], f: [] },
//       { p: new Vec3(+dv, +du, 0), e: [], f: [] },
//       { p: new Vec3(+dv, -du, 0), e: [], f: [] },
//       { p: new Vec3(-dv, +du, 0), e: [], f: [] },
//       { p: new Vec3(-dv, -du, 0), e: [], f: [] },
//     ]
...
//     return new Icosahedron(nodes, edges, faces)
//   }


//   generateSubdividedIcosahedron(degree: number) {
//     const icosahedron = Icosahedron.generateIcosahedron()
